        ...
        list: [
          {
            ...
            posizione: "2° Posto",
            piatto: "Black Dragon",
            desc: "Il nostro panino Black Dragon ha conquistato il secondo posto alla Crunchy Competition 2026, uno dei contest più prestigiosi dedicati ai migliori burger artigianali d'Italia.",
          },
          {
            anno: "2022",
            nome: "World Steak Challenge",
            posizione: "Partner Ufficiale MFC Carni",
            sottotitolo: "Miglior produttore al mondo · Dublino 2022",
            desc: "Ossobuco è ristorante partner di MFC Carni, premiata come miglior produttore di bistecca al mondo al World Steak Challenge 2022 a Dublino. Far parte della famiglia MFC significa avere accesso alle carni più pregiate e certificate d'Italia e d'Europa, selezionate tra le migliori razze bovine del pianeta.",
          },
        ],
      },
      filosofia: {
      ...
      premi: {
        ...
        list: [
          ...
          },
          {
            anno: "2022",
            nome: "World Steak Challenge",
            posizione: "Official Partner MFC Carni",
            sottotitolo: "Best steak producer in the world · Dublin 2022",
            desc: "Ossobuco is an official partner restaurant of MFC Carni, awarded best steak producer in the world at the 2022 World Steak Challenge in Dublin. Being part of the MFC family means accessing Italy and Europe's finest certified beef, selected from the world's best cattle breeds.",
          },
        ],
      },
      filosofia: {
