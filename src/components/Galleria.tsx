...
const items: GalleryItem[] = [
  ...
  { src: "antipasto-vino.webp",   caption_it: "Antipasto e vino — l'apertura perfetta",         caption_en: "Antipasto and wine — the perfect opening",   category: "cibo" },
