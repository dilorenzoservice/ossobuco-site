      ...
      <div className="grain-overlay">
        <div className="relative z-10 container mx-auto px-4 py-14 md:py-20 text-center">
          ...
          <motion.div className="space-y-2 mb-8"
            ...
            <p className="text-osso-parchment/25 text-xs tracking-wider pt-1">P.IVA IT03828660716</p>
          </motion.div>

          {/* Legal links */}
          <motion.div className="flex items-center justify-center gap-3 mb-6"
            initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.28 }}>
            <Link to="/privacy"
              className="text-osso-parchment/25 hover:text-osso-parchment/60 text-[10px] uppercase tracking-[0.15em] transition-colors duration-300 underline underline-offset-2">
              Privacy Policy
            </Link>
            <span className="text-osso-parchment/15 text-[10px]">·</span>
            <Link to="/cookie"
              className="text-osso-parchment/25 hover:text-osso-parchment/60 text-[10px] uppercase tracking-[0.15em] transition-colors duration-300 underline underline-offset-2">
              Cookie Policy
            </Link>
